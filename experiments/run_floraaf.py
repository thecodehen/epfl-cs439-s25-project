...
from src.floraAdamFactoredMAS import FloraAdamFactoredMAS
...
def main():
    ...
    save_path = pathlib.Path('results') / 'floraAF' / f"lr_{args.lr}-kappa_{args.kappa}-rank_{args.rank}-hidden_size_{args.hidden_size}-clip_norm_{args.clip_norm}-seed_{args.seed}-epochs_{args.epochs}-{timestamp}"
